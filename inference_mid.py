...
import datetime
import numpy as np
from SalGANmore import SalGANmid
import pickle
import torch
...
clip_length = 10 #with 10 clip length the loss seems to reach zero very fast
...
dst = "/imatge/lpanagiotis/work/DHF1K/SalGANmid_predictions"
# Parameters
